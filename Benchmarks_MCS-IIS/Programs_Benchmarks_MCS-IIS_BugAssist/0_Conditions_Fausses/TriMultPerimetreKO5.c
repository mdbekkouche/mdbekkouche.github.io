 ...
 * 
 * ERROR in condition line 33 and condition line 48 : for (2,2,3) the program should return 12
 */
	...
	void TriMultPerimetreKO5 (int i, int j, int k) {__CPROVER_assume((i == 2) && (j == 2) && (k ==3));
		int trityp = 0;
		int res;
		if (i == 0 || j == 0 || k == 0) {
			trityp = 4;	
