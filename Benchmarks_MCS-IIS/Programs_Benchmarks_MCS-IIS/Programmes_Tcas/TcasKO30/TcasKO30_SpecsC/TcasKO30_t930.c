...
void TcasKO30(int Cur_Vertical_Sep,int High_Confidence,int Two_of_Three_Reports_Valid,int Own_Tracked_Alt,int Own_Tracked_Alt_Rate,int Other_Tracked_Alt,int Alt_Layer_Value,int Up_Separation,int Down_Separation,int Other_RAC,int Other_Capability,int Climb_Inhibit)
	...
	alt_sep = UNRESOLVED;
		...
		if (Climb_Inhibit){
		    ...
		    Inhibit_Biased_Climb=Up_Separation + NOZCROSS; /* Add code, the instruction should be : Inhibit_Biased_Climb=Up_Separation; */
		}
