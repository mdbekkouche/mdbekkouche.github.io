...
void TcasKO22(int Cur_Vertical_Sep,int High_Confidence,int Two_of_Three_Reports_Valid,int Own_Tracked_Alt,int Own_Tracked_Alt_Rate,int Other_Tracked_Alt,int Alt_Layer_Value,int Up_Separation,int Down_Separation,int Other_RAC,int Other_Capability,int Climb_Inhibit)
	...
	alt_sep = UNRESOLVED;
		...
		if (Up_Separation > Down_Separation) /* code mutation, the insruction should be : (Inhibit_Biased_Climb > Down_Separation); */
		    {  
